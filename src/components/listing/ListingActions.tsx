...
export default function ListingActions({ listingId, title, whatsappNumber }: ListingActionsProps) {
  ...
  return (
    <div className="flex items-center gap-2">
      <button
        onClick={handleShare}
        className="flex items-center gap-1.5 px-4 py-2 border border-gray-200 rounded-xl text-sm font-semibold text-gray-600 hover:border-[#005F56] hover:text-[#005F56] transition-all"
      >
      ...
      <button
        ...
        className="flex items-center gap-1.5 px-4 py-2 border border-gray-200 rounded-xl text-sm font-semibold text-gray-600 hover:border-[#25D366] hover:text-[#25D366] transition-all"
      >
